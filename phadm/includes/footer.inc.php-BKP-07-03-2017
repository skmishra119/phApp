...
?>
		<div id="footer">
			<div align="center">&copy; <?php echo date('Y'); ?> <a href="http://www.trushieldinc.com" target="_blank">Trushield Inc.</a>, All rights reserved.</div>
		</div>
		</div>
     ...
     $(document).ready(function(){
	    ...
	    $("#btnRepPDF").bind("click",function(){
			...
			var img = canvas.toDataURL("image/png");
   			...
   			$.ajax({
   					type: "POST", 
   					url: "<?php echo DROOT.XROOT; ?>getimg", 
   					data: data,
