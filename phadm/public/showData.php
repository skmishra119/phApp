...
if(trim($USERINFO['userid'])=='' || trim($USERINFO['role'])=='') header("Location:./");
...
$VTYPS = array('TOTAL-CLIENTS','ACTIVE-CLIENTS','INACTIVE-CLIENTS','TEST_TARGETS','TOTAL-TARGETS','TOTAL_TEST','TEST_STATUS','TOTAL-TESTS','OVERALL_ANALYSIS','TEST_ANALYSIS','GROUP_TEST_ANALYSIS','DOMAIN_TEST_ANALYSIS','USER_EVENT_TEST_ANALYSIS');
try{
...
//var_dump(strtoupper(trim($_REQUEST['typ'])));
switch(strtoupper(trim($_REQUEST['typ']))){
    ...
    case "ACTIVE-GROUPS": $text='fa fa-envelope fa-fw'; break;
