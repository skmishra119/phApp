...
if(trim($FORMAT)=='PDF'){
	...
	<style type="text/css">
		...
		#header { margin: 0; padding: 0; position: fixed; top: -70px;  width: 100%; z-index: 1000; }
		#footer { margin: 0; padding: 2px 10px 2px 10px; position: fixed; bottom: -20px; border-top: 1px solid #000; font-size: 90%; font-weight: bold; width: 100%;  height:20px; z-index: 1001; }
		#header, #footer { clear: both; float: none; color:#000;}
